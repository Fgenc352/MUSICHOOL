...
let qry =
    "UPDATE  Course SET  CourseCode=\'" +CourseCode +"'\,"+"InstructorSSN=\'" + InstructorSSN +"'\,"+"InstrumentName=\'" +InstrumentName +"'\,"+"CourseHour=\'" +CourseHour +"'\,"+"Quota=\'"+Quota +"'\,"+" Price=\'"+Price+"'\ where CourseCode=\'"+CourseCode+"\'"

      axios
      .post("http://localhost:4000/updateCourse", { qry })
      .then((res) => {
          console.log(res);
  ...
  const handleChange = (e) => {
    setCourseCode(e.target.value)
      ...
      axios
      .post("http://localhost:4000/CourseInfo",{ courseCode: e.target.value })
      .then((res) => {
